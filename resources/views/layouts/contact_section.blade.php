                ...
                {!! Form::open(array('route' => 'contact_post', 'method' => 'POST', 'name' => 'sentMessage', 'id' => 'contactForm')) !!}
                    <div class="control-group">
                        <div class="form-group floating-label-form-group controls">
                            ...
                            {!! Form::text('name', '', array('class' => 'form-control input-lg', 'placeholder' => 'Your Name', 'id' => 'contact_name', 'data-validation-required-message' => 'Please enter your name')) !!}
                    ...
                    <div class="control-group">
                        <div class="form-group floating-label-form-group controls">
                            ...
                            {!! Form::text('name', '', array('class' => 'form-control input-lg', 'placeholder' => 'Your Email', 'id' => 'contact_email', 'data-validation-required-message' => 'Please enter email')) !!}
                            <span class="help-block text-danger"></span>
                        </div>
                    </div>
                    <div class="control-group">
                        <div class="form-group floating-label-form-group controls">
                            ...
                            {!! Form::text('phone', '', array('class' => 'form-control input-lg', 'placeholder' => 'Your Phone', 'id' => 'contact_phone', 'data-validation-required-message' => 'Please enter phone')) !!}
                            <span class="help-block text-danger"></span>
                        </div>
                    </div>
                    <div class="control-group">
                        <div class="form-group floating-label-form-group controls">
                            ...
                            {!! Form::textarea('message', '', array('rows' => '2', 'class' => 'form-control input-lg', 'placeholder' => 'Please enter a message', 'id' => 'contact_message', 'data-validation-required-message' => 'Please enter a message', 'aria-invalid' => 'false')) !!}
                            <span class="help-block text-danger"></span>
                        </div>
                    </div>
